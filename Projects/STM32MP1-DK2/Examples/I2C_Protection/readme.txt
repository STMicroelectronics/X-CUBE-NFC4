/**
  @page I2C_Protection setting features of ST25DV for dynamic NFC/RFID tag IC Expansion Board and STM32 Nucleo Boards
  ...
  * @version V2.0.3
  * @date    20-May-2021
  * @brief   This application contains an example to create areas in the ST25DV and how to protect them
  ******************************************************************************
  * @attention
  *
...
This example application shows how to create areas in the ST25DV and how to protect them
------------------------------------
...
In order to make the program work, you must do the following:
 - WARNING: before opening the project with any toolchain be sure your folder
   ...
   after building.
 - Open STM32CubeIDE (this firmware has been successfully tested with Version 2.9.0).
