/**
  @page LPD sample application for dynamic NFC/RFID tag IC Expansion Board and STM32 Nucleo Boards
  ...
  * @version V2.0.3
  * @date    20-May-2021
  * @brief   This application contains an example to show how to activate low power down (LPD) pin
  ******************************************************************************
  * @attention
  *
